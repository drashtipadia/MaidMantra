...
session_start();
$checkquery="SELECT * FROM user WHERE name='".$_SESSION['u_name']."' and password ='".$_POST['uoldpassword']."'";
$checkres=mysqli_query($con,$checkquery);
if(mysqli_num_rows($checkres)===1)
{
        $query="UPDATE user SET password='".$_POST['unewpassword']."' WHERE name='".$_SESSION['u_name']."'";
